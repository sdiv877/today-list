...
import { initUserData, loadUserData, saveUserData } from './utils/user_data';
...
ipcMain.on('setBackgroundColour', (event, bgColour) => {

  if (BrowserWindow.getAllWindows()[0].getBackgroundColor().toLowerCase() != bgColour)
    dialog.showMessageBox({
      type: 'info',
      title: 'Colour changes saved',
      message: 'The colour you selected will be applied the next time you open Today List.',
      buttons: ['Ok']
    })
});
