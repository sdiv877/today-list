...
import { initDatabase, loadCurrentList, addToCurrentList, deleteFromCurrentList } from './utils/sqlite';
...
ipcMain.on('deleteFromCurrentList', (event, task) => {
  deleteFromCurrentList(task);
});