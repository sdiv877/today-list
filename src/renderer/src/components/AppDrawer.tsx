        ...
        >
            <List>
                ...
                <div className="appDrawerButtons" onClick={() => setSelectedRoute(getCurrentRoute())}>
                    <AppDrawerButton label={'Current Tasks'} selected={selectedRoute} path={PageRoute.CURRENT_TASKS} />
                    <AppDrawerButton label={'Completed Tasks'} selected={selectedRoute} path={PageRoute.COMPLETED_TASKS} />
                    <AppDrawerButton label={'Recycle Bin'} selected={selectedRoute} path={PageRoute.RECYLE_BIN} />
                    <Divider orientation="horizontal" />
                    <AppDrawerButton label={'Stats'} selected={selectedRoute} path={PageRoute.STATS} />
                    <Divider orientation="horizontal" />
                    <AppDrawerButton label={'Settings'} selected={selectedRoute} path={PageRoute.SETTINGS} />
                    <Divider orientation="horizontal" />
                </div>
            </List>
        </Drawer>);
